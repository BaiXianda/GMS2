...
for( i = 0; i < array1Index; i+= 4) {
	...
	for( j = i + 4; j < array1Index; j+= 4) {
		if x2 + tile_size == array1[j + 1] && y2 == array1[j+3] {
			x2 = array1[j + 1]
			y2 = array1[j + 3] 
			count++
		} else {
...
for( i = 0; i < array2Index; i+= 4) {
	...
	for( j = i + 4; j < array2Index; j+= 4) {
		if x2 == array2[j+1] && y2 + tile_size == array2[j+3] {
			x2 = array2[j + 1]
			y2 = array2[j + 3] 
			count++
		} else {
...
for( i = 0; i < array1Index; i += 4) {
	...
	var j = 0
	var count = 0
	for( j = 0; j < array1Index; j+= 4) {
		if i == j {
			continue
		}
		if (x2 == array1[j+1] && y2 + tile_size == array1[j+3]) ||  
			(x2 + tile_size == array1[j+1] && y2 == array1[j+3]) || 
			(x2 == array1[j+1] && y2 - tile_size == array1[j+3]) ||
			(x2 - tile_size == array1[j+1] && y2 == array1[j+3]) {
			count++
		} 
	}
