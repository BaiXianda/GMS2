...
for( i = 0; i < array1Index; i += 4) {
	...
	for( j = 0; j < array1Index; j+= 4) {
		...
		if x2 + 32 == array1[j+1] || y2 + 32 == array1[j+3] 
			|| x2 - 32 == array1[j+1] || y2 - 32 == array1[j+3] {
			count++
		} 
	}
