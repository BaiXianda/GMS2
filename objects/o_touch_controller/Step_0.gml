	...
	if position_meeting(mx, my, o_play){
		...
		if device_mouse_check_button_pressed(dv, mb_left) {
			if o_pause.paused == 0 {
				...
				instance_destroy(o_fire)
				instance_destroy(o_wood)
			}
